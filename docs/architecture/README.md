...
# Architecture & Benchmarks Index / アーキテクチャ & ベンチマーク

This directory manages knowledge related to system architecture and real-device hardware benchmark evaluations.

本ディレクトリでは、システム設計および実機ハードウェアにおけるベンチマーク評価ナレッジを管理します。

## Document List / ドキュメント一覧

* [大規模マルチドメインデータセット (N=54) 実機ベンチマーク検証レポート](./benchmark_report_n54.md) / [English](./benchmark_report_n54.en.md)
